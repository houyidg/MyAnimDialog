...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private final String defDialogColor = "#ffffa800";
    ...
    private void startDismiss(Effectstype type,Dialog dialog) {
        BaseEffects animator = type.getOppositeAnimator();
        if (mDuration != -1) {
            animator.setDuration(Math.abs(mDuration));
        }
        animator.startDimiss(mRelativeLayoutView,dialog);
    }
