...
import com.gitonway.lee.niftymodaldialogeffects.lib.AnimConfig;
...
public class SlideBottom extends BaseEffects{
    ...
    protected void setupAnimation(View view) {
        getAnimatorSet().playTogether(
                ObjectAnimator.ofFloat(view, "translationY", 0, AnimConfig.TOP_BTM_TRANSLATE_Y).setDuration(mDuration),
